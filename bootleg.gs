...
var channels = [["How to properly clean your metal computer", "UCRPj5iCNYgvUMBq8Tga68hw"],
                ["GiivλSunner", "UCOrh4EtSPV8BZoK2o9cxCxg"],
                ["BrawlBRSTMs3 X", "UCk8uORkwM6prnfmK2Blpfnw"],
                ["recordcollector1972", "UCiGK0KvXhB2D7bKSz-b3y0w"],
                ["SilvaLatinaGunner", "UCf-OlLPEwmjIlqavCM8-Mlg"],
                ["SilvioGunner", "UCzqiNG9Ii8L3dZzLI90VDPA"],
                ["ViIgaNusser", "UC97EJOCwh3eDyXt5fyZjZ4w"],
                ["old generic ripping channel", "UCCqAAU6LTZSX8ZcCpI_dpyg"],
                ["ViIvaNunner", "UCx8R_K46oW7-3WMFVqQBAIQ"],
                ["NoobaZunner", "UCNt0UThru4-_M4D9K7QLk-g"],
                ["RinsaVuIIer", "UC4c9zsxHsynJMqbM1I3TFwg"],
                ["СильваОружейник", "UCnWDgEZ_aozAnFf1MRpkt5Q"],
                ["SulvaGinner", "UC2YKR5iZfRzTqGRisrJZ1BA"],
                ["BIizzaStunner", "UCyIOZ0aXWJjCfR3A4HcxLdg"],
                ["Nafun", "UC_t0SR_fr1uwHaR4QaQ0j_g"],
                ["BaldiGunner", "UChYWqGkZNA8nNIGS400NFuw"],
                ["Brawlcats Music", "UCYMQ-W0yVBWxgpxymqPxneg"],
                ["Cub", "UCegJwAR3I1tsMzSA0Xgmqvg"],
                ["Dannver", "UCMHMSEDbS4wjFcrz2c7BKPQ"],
                ...
                ["ChriIvaBrunner", "UC4hH5KDotgrpaWuF6885mJw"],
                ...
                ["THIS PROJECT IS RETIRED", "UCOKS1QCxTSz7p_GWIuGi2dg"],
...
{  
  ...
  for (var i in channels)
  {
    ...
    if (channelSheet.getRange(2, 1).getDisplayValue() == "a")
...
function checkBootlegSheet()
{
  ...
  if (channel != "Low Quality RipsTM" && channel != "WoopaCrunner" && channel != "Nafun")
    addNewVideos();
  ...
  try
  {
    ...
    while (updateCount < 25 && currentTime.getTime() - startTime.getTime() < 90000)
  } 
  catch(e)
  {
    Logger.log(e);
  ...
  function checkVideoStatus(row)
  {
    ...
    do
    {
      ...
      catch (e)
      {
        ...
        if (currentTime.getTime() - startTime.getTime() > 90000)
         break;
      }
    }
